...
function DocsIndexPage() {
  ...
  return (
    <InAppDocsShell
      ...
      description="Concepts and behavior of this app—workspaces, how the AI context is built, tools, dashboard, memory, and what you can expect from the assistant."
    >
